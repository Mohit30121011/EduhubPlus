...
const { getAllMasterData, getDashboardStats, createCourse, createSubject, createDepartment, deleteCourse, updateCourse, updateSubject, updateDepartment } = require('../controllers/masterController');
